...
<x-adminlte-card title="Estadisticas" icon="fas fa-chart-bar">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <x-adminlte-small-box text="Atendidos" title="{{ $toDayCount }}" theme="success"
                icon="far fa-check-circle" />
        </div>
        <div class="col-md-6">

            <x-adminlte-small-box text="Pendientes" title="{{ $pendingCount }}" theme="primary" icon="far fa-clock" />
        </div>
        <div class="col-md-6">
            <x-adminlte-small-box text="Distraidos" title="{{ $distractedCount }}" theme="danger"
